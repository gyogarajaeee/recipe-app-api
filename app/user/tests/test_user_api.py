...
class PublicUserAPITest(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@yoga.com', 'password': 'Test123'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@yoga.com', 'password': 'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email="test@yoga.com", password="Test123")
        payload = {
            'email': "test@yoga.com",
            'password': "test"
        }
    ...
    def test_create_token_missing_field(self):
        """Test that token is not created for missing field"""
